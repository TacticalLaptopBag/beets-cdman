...
- Ability to create a word document containing a list of all the tracks or folders in each CD.
...
- Fixed summary spamming terminal when populating a large number of CDs
- Fixed tracks being populated out of order in certain cases
...
[1.1.1]: https://github.com/TacticalLaptopBag/beets-cdman/releases/tag/v1.1.1
